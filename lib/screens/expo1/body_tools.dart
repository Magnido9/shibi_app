            ...
            child: Container(
              child: TweenAnimationBuilder<double>(
                  ...
                  builder:
                    ...
                    return CustomPaint(
                        painter: _LoadBar(
                            percent: 0.5, size: MediaQuery.of(context).size),
        ...
        Align(
          ...
          child: Container(
            child: FloatingActionButton(
              ...
              onPressed: () {
                Navigator.of(context).pushReplacement(MaterialPageRoute(
                    builder: (BuildContext context) => this.widget.prev == 0
                        ? Home()
                        : tools(
                            adata: this.widget.adata,
                            theCase: this.widget.theCase)));
              },
                                ...
                                content: RichText(
                                  ...
                                  text: TextSpan(
                                    ...
                                    children: <TextSpan>[
                                      ...
                                      TextSpan(
                                          text:
                                          'ננסה להרפות את הגוף שלנו בעזרת האפשרויות שמוצעות בעמוד זה.\n'),
