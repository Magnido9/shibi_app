                  ...
                  builder: (context, constraints){
                    ...
                    for (int i =0; i<min(6,widget.thoughts.length);i++){
                      wlist.add(Positioned(
                          top: offsets[i].dy,
                          left: offsets[i].dx,
                          child: Baloon(angle:angles[i],diameter: diameters[i],text:widget.thoughts[i],color: i%4,)
                      )) ;
                    }
...
class Baloon extends StatelessWidget{
  ...
  final double angle;
  final int color;
  final colors=[Color(0xffE0CBDD),Color(0xffDEEEF3),Color(0xffCFC781).withOpacity(0.26),Color(0xff81CF8D).withOpacity(0.26),];


  @override
  Widget build(BuildContext context){
    return Container(height: diameter, width: diameter, child: Stack(
      children: [
        Center(
          child: Container(
            width: 0.8*diameter,
        ...
        Transform.rotate(
          angle: angle,
          child: ImageColorSwitcher(height: diameter, width: diameter, imagePath: 'images/expo/baloon.png', main: Color(0xff000000),second: Color(0xff95DEF4),color: colors[color],),
