 ...
 bool isChecked=false;
  ...
  Widget build(BuildContext context){
    ...
    *MediaQuery.of(context).size.height,
    ...
    Positioned(right:32,top:97,child:
      Align(
    ...
    fontWeight: FontWeight.w900,
      ...
      Container(
        ...
        height: 2,
        decoration: BoxDecoration(
          border: Border.all(color: Color(0x2d34248a), width: 1, ),
        ),
      )
      ,
    ...
    Positioned(top:MediaQuery.of(context).size.height*0.5,right:MediaQuery.of(context).size.width/2-100,child:
    Row(children:<Widget>[
      Checkbox(
