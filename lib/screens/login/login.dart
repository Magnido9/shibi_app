...
class _MainScreenState extends State<LoginPage> {
  ...
  Widget build(BuildContext context) {
    ...
    *MediaQuery.of(context).size.height,
    ...
    Align(alignment: Alignment.topRight,child:Column(crossAxisAlignment:CrossAxisAlignment.end,mainAxisAlignment:MainAxisAlignment.start,children:<Widget>[ Container(height:20),Row(crossAxisAlignment:CrossAxisAlignment.end,mainAxisAlignment:MainAxisAlignment.end,children:<Widget>[ Container(width:20),Image.asset("images/sheba.png"),Container(width:20),])])),
    Column(
          mainAxisAlignment: MainAxisAlignment.center,
          children: [Image.asset("images/logo.png"),
            Text("הרשמה/התחברות לאפליקציה", style: GoogleFonts.assistant(fontSize: 26,fontWeight: FontWeight.w700)),
            Container(
