    ...
    return MaterialApp(
        home: Scaffold(
          ...
          body: StreamBuilder<List<QueryDocumentSnapshot>>(
            stream: FirebaseFirestore.instance.collection('users').where('caretakeId',isEqualTo: AuthRepository.instance().user?.uid).snapshots().map( (value) => value.docs),
          ...
          floatingActionButton: FloatingActionButton(
            ...
            onPressed: (){FirebaseFirestore.instance.collection("caretakers").doc(AuthRepository.instance().user?.uid).set({
